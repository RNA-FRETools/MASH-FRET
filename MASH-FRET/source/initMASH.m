...
h_TPpan = [h.uipanel_TP_plot,h.uipanel_TP_subImages,...
    h.uipanel_TP_backgroundCorrection,h.uipanel_TP_sampling,...
    h.uipanel_TP_crossTalks,h.uipanel_TP_denoising,...
    h.uipanel_TP_photobleaching,h.uipanel_TP_factorCorrections,...
    h.uipanel_TP_findStates];
...
h_mainPan = [h_Span,h_VPpan,h_TPpan,h.uipanel_TP_sampleManagement,...
    h_HApan,h_TApan];

...
% default
lbl0 = 'All panels';
lbl1 = 'panel "Sample management"';
lbl2 = 'panel "Plot"';
lbl3 = 'panel "Sub-images"';
lbl4 = 'panel "Background"';
lbl5 = 'panel "Cross-talks"';
lbl6 = 'panel "Denoising"';
lbl7 = 'panel "Photobleaching"';
lbl8 = 'panel "Factor corrections"';
lbl9 = 'panel "Find states"';
...
h.menu_TP_sampleManagementTest = uimenu(h_men,'label',lbl1,'callback',...
    {@menu_routineTest_Callback,'tp','sample management',h_fig});

h.menu_TP_plotTest = uimenu(h_men,'label',lbl2,'callback',...
    {@menu_routineTest_Callback,'tp','plot',h_fig});

h.menu_TP_subImagesTest = uimenu(h_men,'label',lbl3,'callback',...
    {@menu_routineTest_Callback,'tp','sub-images',h_fig});

h.menu_TP_backgroundTest = uimenu(h_men,'label',lbl4,'callback',...
    {@menu_routineTest_Callback,'tp','background',h_fig});

h.menu_TP_crossTalksTest = uimenu(h_men,'label',lbl5,'callback',...
    {@menu_routineTest_Callback,'tp','cross-talks',h_fig});

h.menu_TP_denoisingTest = uimenu(h_men,'label',lbl6,'callback',...
    {@menu_routineTest_Callback,'tp','denoising',h_fig});

h.menu_TP_photobleachingTest = uimenu(h_men,'label',lbl7,'callback',...
    {@menu_routineTest_Callback,'tp','photobleaching',h_fig});

h.menu_TP_factorCorrectionsTest = uimenu(h_men,'label',lbl8,'callback',...
    {@menu_routineTest_Callback,'tp','factor corrections',h_fig});

h.menu_TP_findStatesTest = uimenu(h_men,'label',lbl9,'callback',...

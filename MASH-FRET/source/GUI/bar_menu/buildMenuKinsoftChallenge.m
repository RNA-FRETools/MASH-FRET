...
h.menu_kinSoft_step2 = uimenu(h_men,'label',lbl3,'callback',...
    {@menu_kinSoft_Callback,2,h_fig});

h.menu_kinSoft_step3 = uimenu(h_men,'label',lbl4,'callback',...
    {@menu_kinSoft_Callback,3,h_fig});

% h.menu_kinSoft_step4 = uimenu(h_men,'label',lbl5,'callback',...

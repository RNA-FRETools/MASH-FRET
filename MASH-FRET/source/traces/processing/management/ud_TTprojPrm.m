...
if ~isempty(p.proj)
    ...
    if nFRET>0
        set([h.text_filtCorr h.checkbox_pbGamma h.pushbutton_optGamma ...
            h.popupmenu_gammaFRET h.edit_gammaCorr],'Visible','on');
    else
        set([h.text_filtCorr h.checkbox_pbGamma h.pushbutton_optGamma ...
            h.popupmenu_gammaFRET h.edit_gammaCorr],'Visible','off');
    end

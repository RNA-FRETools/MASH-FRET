...
if method == 6
    coord_dark = p.proj{proj}.curr{mol}{3}{3}{exc,chan}(method,4:5);
    ...
    p.proj{proj}.curr{mol}{3}{3}{exc,chan}(method,4:5) = coord_dark;
    h.param.ttPr = p;
    guidata(h_fig, h);

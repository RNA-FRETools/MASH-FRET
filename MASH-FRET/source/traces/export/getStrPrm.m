        ...
        for i = 1:(nFRET+nS)
            switch prm_dta{1}(1)
                ...
                case 4 % CPA
                    ...
                    str_dta = sprintf(strcat('%s %i bootstrap samples', ...
                        ', %d significance level', ...
                        ', identify changes by %s', ...
                        ', %i refinment cycles', ...
                        ', state binning  %d\n'), str_dta, ...
                        prm_dta{2}(prm_dta{1}(1),1,i), ...
                        prm_dta{2}(prm_dta{1}(1),2,i)/100, ...
                        str, ...
                        prm_dta{2}(prm_dta{1}(1),5,i), ...
                        prm_dta{2}(prm_dta{1}(1),6,i));
                ...
                case 1 % thresholding
                    ...
                    if i > nFRET+nS
                        str_dta = sprintf(strcat( ...
                            ...
                            str_dta, prm_dta{2}(prm_dta{1}(1),1,i), ...
                            prm_dta{2}(prm_dta{1}(1),5,i), ...
                            prm_dta{2}(prm_dta{1}(1),6,i));
                        ...
                        str_dta = sprintf(strcat( ...
                            '%s tolerance window size %i', ...
                            ', %i refinment cycles', ...
                            ', state binning %d\n'), ...
                            str_dta, prm_dta{2}(prm_dta{1}(1),4,i), ...
                            prm_dta{2}(prm_dta{1}(1),5,i), ...
                            prm_dta{2}(prm_dta{1}(1),6,i));
                    end
...
str_prm = sprintf(str_header, proj_file, s.date_creation, ...
    s.date_last_modif, vers, movie_file, coord_file, ...

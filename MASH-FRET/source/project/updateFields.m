...
%             300  0.067 113  0 5.199 0.95 ];%  g    s_d my.d CIC s    eta 
    ...
    switch p.noiseType
        case 'poiss' % Poisson or P-model from Börner et al. 2017
            ...
            set(h.text_camNoise_01, 'Style', 'text', 'String', [char(hex2dec('3BC')),'_ic,dark']);
            set(h.text_camNoise_02, 'Style', 'text', 'String', char(hex2dec('3B7')));
        ...
        case 'norm' % Gaussian, Normal or N-model from Börner et al. 2017
            ...
            set([h.text_camNoise_01 h.edit_camNoise_01 ...
                ...
                h.text_camNoise_04 h.edit_camNoise_04 ...
                h.text_camNoise_05 ...
                h.text_camNoise_04 h.edit_camNoise_06], 'Enable', 'on');
            
            set(h.edit_camNoise_05, 'Enable', 'inactive');
            
            [o, mu_rho_stat] = Saturation(p.bitnr);
            
            set(h.text_camNoise_01, 'String', 'K:');
            set(h.text_camNoise_02, 'String', 's_d:');
            set(h.text_camNoise_03, 'String', 'my.d:');
            set(h.text_camNoise_04, 'String', 's_q:');
            set(h.text_camNoise_05, 'String', 'mr.s:', 'TooltipString', ...
                'Max. number of photons that hit the a single pixel area');
            set(h.text_camNoise_06, 'String', 'eta:');
            ...
            set(h.edit_camNoise_02, 'String', ...
                num2str(p.camNoise(ind,2)), 'TooltipString', ...
                ['Noise standard deviation of the Gaussian ' ...
                'contribution (PC/frame)']); % s_d
            ...
            set(h.edit_camNoise_04, 'String', ...
                ...
                ' analog digital conversion (PC/frame)']); % s_q
            set(h.edit_camNoise_05, 'String', ...
                num2str(mu_rho_stat)); % mu_r.stat
        ...
        case 'user' % User defined or NExpN-model from Börner et al. 2017
            ...
            set([h.text_camNoise_01 h.edit_camNoise_01 ...
                h.text_camNoise_02 h.edit_camNoise_02 ...
                h.text_camNoise_03 h.edit_camNoise_03 ...
                h.text_camNoise_04 h.edit_camNoise_04],'Enable','on');
            
            set([h.text_camNoise_05 h.edit_camNoise_05 ...
                h.text_camNoise_06 h.edit_camNoise_06],'Enable','off', ...
                'String', '');
            
            set(h.text_camNoise_01, 'String', 'I_th:');
            set(h.text_camNoise_02, 'String', 'A:');
            set(h.text_camNoise_03, 'String', 'tau:');
            set(h.text_camNoise_04, 'String', 'sig:');
%             set(h.text_camNoise_05, 'String', 'c:');
%             set(h.text_camNoise_06, 'String', 'a:');

            set(h.edit_camNoise_01, 'String', ...
                num2str(p.camNoise(ind,1)), 'TooltipString', ...
                'Camera offset (EC/frame)');
            set(h.edit_camNoise_02, 'String', ...
                num2str(p.camNoise(ind,2)), 'TooltipString', ...
                'CIC exponential tail contribution');
            set(h.edit_camNoise_03, 'String', num2str(p.camNoise(ind,3)), ...
                'TooltipString', 'CIC decay constant (EC/frame)');
            set(h.edit_camNoise_04, 'String', num2str(p.camNoise(ind,4)), ...
                'TooltipString', ...
                'Initial width of the camera noise (EC/frame)');
%             set(h.edit_camNoise_05, 'String', num2str(p.camNoise(ind,4)), ...
%                 'TooltipString', 'Gaussian noise width exponent');
%             set(h.edit_camNoise_06, 'String', num2str(p.camNoise(ind,5)), ...
%                 'TooltipString', 'Gaussian width enhancment factor');
        ...
        case 'hirsch'
            ...
            set(h.text_camNoise_01, 'String', 'g:');
            set(h.text_camNoise_02, 'String', 's_d:');
            set(h.text_camNoise_03, 'String', 'my.d:');
            set(h.text_camNoise_04, 'String', 's_q:');
            set(h.text_camNoise_05, 'String', 's:', 'TooltipString', ...
                'Max. number of photons that hit the a single pixel area');
            set(h.text_camNoise_06, 'String', 'eta:');

            set(h.edit_camNoise_01, 'String', ...
                num2str(p.camNoise(ind,1)), ...
                'TooltipString', 'System gain (PC/electron/frame)'); % K
            set(h.edit_camNoise_02, 'String', ...
                num2str(p.camNoise(ind,2)), 'TooltipString', ...
                ['Noise standard deviation of the Gaussian ' ...
                'contribution (PC/frame)']); % s_d

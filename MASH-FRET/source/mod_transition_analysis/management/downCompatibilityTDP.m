...
if isfield(prm,'kin_res') && ~isfield(prm,'lft_res') % reset fit results
    fprintf(['Dwell time analysis is outdated: fitting results have ',...
        'been reset.\nTo access the old dwell time analysis results, ',...
        'please use MASH-FRET 1.3.1 (https://github.com/RNA-FRETools/',...
        'MASH-FRET/releases/tag/v1.3.1) or older.'])

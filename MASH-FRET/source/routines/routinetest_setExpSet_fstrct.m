...
set(h.edit_hLines,'string',num2str(nhline));
...
if istraj
    ...
    % set histogram bin column
    set(h.edit_xval,'string',num2str(prm(3)));
    edit_setExpSet_xval(h.edit_xval,[],h_fig);

    % set histogram counts column
    set(h.edit_countval,'string',num2str(prm(4)));
    edit_setExpSet_countval(h.edit_countval,[],h_fig);
end

...
for r = rspl
    ...
    pushbutton_addTag2pop_Callback(q.pushbutton_addTag2pop,[],h_fig);
...
while r>0
    ...
    for tag = 1:nTag
        ...
        pushbutton_remPopTag_Callback(q.pushbutton_remPopTag,[],h_fig);
    end
    
    % dismiss range
    pushbutton_dismissRange_Callback(q.pushbutton_dismissRange,[],h_fig);

function [h2d, binC_x, binC_y, mesh_minmaxN_xy] = hist2D(vxy, mesh_minmaxN_xy, varargin)
...
% 2018.01.05    - adapted for MASH by Richard Börner
...
if flagUnrec % report unknown identifiers
    ...
    disp(['hist2D: unrecognized mode(s), using ' strGrid ', ' strMode] );
end

...
%                     set(h.pushbutton_optGamma,'enable','off');
                    set(h.pushbutton_optGamma,'String','Load',...
                        'tooltipstring',cat(2,'<html><b>Import gamma ',...
                        'factors</b> from ASCII files.</html>'));
...
%                     set(h.pushbutton_optGamma,'enable','on');
                    set(h.pushbutton_optGamma,'String','Opt.',...
                        'tooltipstring',cat(2,'<html><b>Open method ',...
                        'settings</b> for factor estimation via acceptor ',...
                        'photobleaching.</html>'));

...
if isMov && isCoord
    ...
    set([h.popupmenu_TP_subImg_channel,h.text_TP_subImg_channel,...
        ...
        h.text_TP_subImg_x,h.text_TP_subImg_y,h.checkbox_refocus],'enable',...
        'on');
else
    set(h.checkbox_refocus,'enable','off');
    if isCoord
    ...
    if isMov
        set([h.text_contrast,h.slider_contrast,h.text_brightness,...

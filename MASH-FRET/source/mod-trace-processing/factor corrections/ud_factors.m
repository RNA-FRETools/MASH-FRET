...
if nFRET==0
    set([h.text_TP_factors_fact h.popupmenu_gammaFRET ...
        h.text_TP_factors_method h.popupmenu_TP_factors_method ...
        h.text_TP_factors_gamma h.text_TP_factors_beta h.edit_gammaCorr ...
        h.edit_betaCorr h.pushbutton_optGamma],'Enable','off');
    set([h.edit_gammaCorr,h.edit_betaCorr],'String','');
    return
end

if curr_fret<1
    set([h.text_TP_factors_fact,h.popupmenu_gammaFRET],'Enable','on')
...
set([h.text_TP_factors_fact h.popupmenu_gammaFRET h.text_TP_factors_method ...
    ...
    h.text_TP_factors_beta h.pushbutton_optGamma],'Enable','on');

...
set([h.pushbutton_loadMov,h.pushbutton_VP_freeMem,h.edit_movFile,...
    h.text_frameCurr,h.text_frameEnd,h.text_movW,h.text_movH,h.text_split,...
    h.slider_img],'enable','on','visible','on');
